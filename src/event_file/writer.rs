...
use crate::event_file::parser::{AccountType, MappedRecord, RetrosheetReader, RecordSlice};
use crate::event_file::schemas::{BoxScoreLineScore, BoxScoreWritableRecord, ContextToVec, Event, EventFieldingPlay, EventHitLocation, EventOut, EventPitch, Game, GameTeam};
...
impl EventFileSchema {
    ...
    fn box_score_schema(line: &BoxScoreWritableRecord) -> anyhow::Result<Self> {
